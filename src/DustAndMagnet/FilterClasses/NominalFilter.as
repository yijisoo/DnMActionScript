package DustAndMagnet.FilterClasses
{
	...
	public class NominalFilter extends Filter
	{
		...
		public function NominalFilter(attribute:String, attributeKey:int, dataManager:DataManager)
		{
			super(attribute, attributeKey, dataManager);
			
			attributeType = DataManager.NOMINAL;
